package com.zxb.dynamic.connection;
 ...
 * @Description
 */
public class ZmConnection implements Connection {

    private Connection connection;

    public ZmConnection(Connection connection) {
        this.connection = connection;
    }

    @Override
    public void commit() throws SQLException {
        // 如果未启用事务，则走connection自身的commit
